...
sap.ui.define([
	...
	"use strict";
	var oMockServer,
		_sAppModulePath = "fin.gl.glview.display/",
	...
	return {
		...
		init: function() {
			var oUriParameters = jQuery.sap.getUriParameters(),
				...
				sEntity = "C_JournalEntryItemBrowserResults",
			...
			oMockServer.simulate(sMetadataUrl, {
				...
				aEntitySetsNames: [
					"C_JournalEntryItemBrowserResults", // Results Entity Set
					"C_JournalEntryItemBrowser",        // Parameter Entity Set
					"I_Ledger",                         // Entity Set for Ledger F4
					"I_Currency",                       // Entity Set for Display Currency F4
					"I_ExchangeRateType"                // Entity Set for Exchange Rate Type F4
				]
			});
